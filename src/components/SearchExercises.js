  ...
  return (
    <Stack alignItems="center" mt="37px" justifyContent="center" p="20px" >
      ...
      <Box position="relative" mb="72px"> 
        ...
        <Button className='search-btn'sx={{ bgcolor: '#FF2625', color: '#fff', textTransform: 'none', width: { lg: '175px', xs: '80px' }, height: '56px', position: 'absolute', right: '0px', fontSize: { lg: '20px', xs: '14px' } }} onClick={handleSearch}>Search</Button>
      </Box>
